// Compiled from CoreIterableIntegerSumEnhancement.gsx
public gw.lang.enhancements.CoreIterableIntegerSumEnhancement extends Object{
  internal final synthetic IType typeparam$T;

  public static Integer sum(Iterable $that$, IType typeparam$T, IFunction1 mapper) {
    sum = 0;
    /*foreach*/
